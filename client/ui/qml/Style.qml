...
QtObject {
    ...
    property color textSecondary: isDark ? "#CCD8E4" : "#617180"
    property color textMuted: isDark ? "#A8B6C6" : "#8D9CAA"
    ...
    property color bubbleMetaInFg: isDark ? "#B1C2D1" : "#90A0AF"
    property color bubbleMetaOutFg: isDark ? "#C0E5D8" : "#658978"
