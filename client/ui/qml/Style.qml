...
QtObject {
    ...
    property color textSecondary: isDark ? "#B3C3D3" : "#617180"
    property color textMuted: isDark ? "#889AAD" : "#8D9CAA"
    ...
    property color bubbleMetaInFg: isDark ? "#7F91A3" : "#90A0AF"
    property color bubbleMetaOutFg: isDark ? "#99C9B8" : "#658978"
