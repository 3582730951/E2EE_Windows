...
QtObject {
    ...
    property color textSecondary: isDark ? "#EAF2FB" : "#617180"
    property color textMuted: isDark ? "#DEE8F2" : "#8D9CAA"
    ...
    property color authSurfaceStrong: Qt.rgba(1, 1, 1, 0.05)
    property color authContextBg: Qt.rgba(12 / 255, 19 / 255, 30 / 255, 0.52)
    property color authContextBorder: Qt.rgba(159 / 255, 187 / 255, 214 / 255, 0.10)
