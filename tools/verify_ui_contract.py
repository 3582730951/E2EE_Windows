    ...
    phase_critical_paths.update(
        {
            ...
            "tools/windows_qml_accessibility_audit.py",
            "tools/windows_qml_text_policy_audit.py",
            "tools/windows_qml_literal_copy_audit.py",
...
def verify_runtime_gate_hooks(errors: list[str]) -> None:
    ...
    for needle in (
        ...
        "Android arm64 waiver missing_gcp_credentials must show missing GCP audit evidence",
